...
insert into Employee(id,name,department,gender,age,contact_number,email) values(1,'Ashish','IT','male',21,9999999999,'Ashish@gmail.com');
insert into Employee(id,name,gender,age) values(2,'Smriti','HR','female',31,898989899,smriti@gmail.com);
insert into Employee(id,name,gender,age) values(3,'maria','Development','female',24,9898767676,'maria@gmail.com');
